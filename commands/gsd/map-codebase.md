...
<process>
0. **Resolve project directory** — follow `~/.claude/get-shit-done/lib/resolve-project.md`. Note: map-codebase can run before `/gsd:new-project`, so if resolver finds no `.planning/` anywhere, proceed in CWD (don't error).
