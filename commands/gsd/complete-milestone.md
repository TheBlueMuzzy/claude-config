...
- @~/.claude/get-shit-done/lib/resolve-project.md (project resolution)
...
**Step 0: Resolve project directory** — follow `~/.claude/get-shit-done/lib/resolve-project.md`. After resolution, re-read `.planning/ROADMAP.md`, `.planning/STATE.md`, and `.planning/PROJECT.md` if they weren't loaded from `<context>`.
