...
<process>
0. **Resolve project directory** — follow `~/.claude/get-shit-done/lib/resolve-project.md`. After resolution, re-read `.planning/STATE.md` and `.planning/ROADMAP.md` if they weren't loaded from `<context>`.
