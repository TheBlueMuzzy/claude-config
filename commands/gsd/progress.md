...
After resolution, re-read `.planning/STATE.md`, `.planning/ROADMAP.md`, and `.planning/PROJECT.md` if they weren't auto-loaded.
</step>
...
## Future Plans
[List items from STATE.md "Future Plans" section - ideas captured for later milestones]
